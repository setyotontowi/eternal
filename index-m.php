...
<head>
	...
	<link rel="stylesheet" type="text/css" href="dist/css/main-m.css">
...
<div class="container-fluid h-100">
	...
	<div class="side content container-fluid">
		<div class="row">
			<section class="main col-md-6 col-sm-12">
				<header class="header main-title p-3 my-3 d-none">
				...
				<div class="season season-title p-3">
					<div class="season season-desc d-none">
			...
			<section class="calendar-outer col-md-6 d-none">
...
<script type="text/javascript">
	$('.season-title h3').html($(window).height());
	var height = $(window).height();
	var distance = $('.card:nth-child(1)').offset().top;
	var lastScrollTop = 0;
	$(document).resize(function(){
		if(height <= $(window).height()){
			$('.sidebar').css("bottom","-14vh");
		}
		else{
	...
	$('.phrase').scroll(function(event){
		var st = $(this).scrollTop();
		if(st>lastScrollTop){
			$('.season-title h3').html("Turun");
			$('.sidebar').css("bottom","-14vh");
		}
		else{
			$('.season-title h3').html("Naik");
			$('.sidebar').css("bottom","0");
		}
		...
		// 	$('.sidebar').css("bottom","0");
		// 	$('.season-title h3').html("Sudah Mentok");
		// }
		// else{
		// 	$('.season-title h3').html("Sudah Mentok");
		// }
