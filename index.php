...
<div class="container-fluid h-100">
	<div class="side sidebar float-left">
		<ul class="list-group">
			<li class="list-group-item py-4 logo"><img src="dist/img/logo-line-24px.svg"></li>
		</ul>
	...
	<div class="side content">
		<div class="row">
			<section class="main col-md-6">
				<header class="header main-title p-3">
				...
				<div class="phrase phrase-container pb-3 px-3">
					<div class="card-container">
						<div class="card my-2 p-4">
							Dari dulu, saya sangat suka menulis. catatan-catatan mengenai apapun bisa anda temukan di kamar, di rak-rak buku, atau di tumpukan kardus-kardus bekas. bahkan, catatan itu juga terselip di media digital seperti laptop atau di smartphone saya. Dan ketika anda telah menemukan salah satu catatan saya, anda akan menjumpai tulisan saya yang sangat kecil. itu adalah sebuah kesengajaan bagi saya untuk mendalami hobi ini. tulisan yang kecil membantu saya untuk menulis lebih banyak tanpa harus membuang halaman baru.
							<div class="row mt-4">
								<div class="col-md-6" style="color: #00ff8c">Hari Ke-3</div>
						...
						<div class="card my-2 p-4">
							...
							<div class="row mt-4">
								<div class="col-md-6">Hari Ke-1</div>
					...
					<div class="btn btn-primary"><b>+</b></div>
				</div>
			</section>
			<section class="calendar-outer col-md-6 my-6">
				<div class="row calendar-desc">
					<div class="col-md-3 desc-header btn-group" role="group">
					...
					<div class="col-md-4 desc-header"></div>
					<div class="col-md-5 desc-header">
